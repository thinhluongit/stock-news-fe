...
import { ChevronLeft, Loader2, Upload, X, Plus, Video, ImageIcon } from 'lucide-react';
  ...
  return (
    <div className="max-w-2xl space-y-5">
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-xl font-bold text-gray-900 dark:text-white">{t('admin.post.new_post')}</h1>
      </div>
          ...
          {mediaFiles.length > 0 && (
            <div className="flex flex-wrap gap-2 mb-2">
              {mediaFiles.map((file, i) => (
                <div key={i} className="relative w-20 h-20 rounded-lg overflow-hidden bg-green-900/20 border border-green-700/40 flex flex-col items-center justify-center gap-1 px-1">
