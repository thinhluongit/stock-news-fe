...
export default function AdminPostsPage() {
  ...
  return (
    <div className="space-y-5">
      ...
      <h1 className="text-xl font-bold text-white">{t('admin.posts')}</h1>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-800">
                  <th className="text-left px-4 py-3 text-gray-400 font-medium">{t('admin.post.title')}</th>
                  <th className="text-left px-4 py-3 text-gray-400 font-medium hidden md:table-cell">{t('admin.post.author')}</th>
                  <th className="text-left px-4 py-3 text-gray-400 font-medium hidden sm:table-cell">{t('admin.post.status')}</th>
                  <th className="text-left px-4 py-3 text-gray-400 font-medium hidden lg:table-cell">{t('admin.post.featured')}</th>
                  <th className="text-left px-4 py-3 text-gray-400 font-medium hidden xl:table-cell">{t('admin.post.views')}</th>
                  <th className="text-left px-4 py-3 text-gray-400 font-medium hidden xl:table-cell">{t('admin.post.date')}</th>
