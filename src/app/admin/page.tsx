        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl">
            <div className="flex items-center justify-between px-5 py-4 border-b border-gray-200 dark:border-gray-800">
              <h2 className="font-semibold text-gray-900 dark:text-white text-sm">{t('admin.recent_users')}</h2>
            ...
            <div className="divide-y divide-gray-200 dark:divide-gray-800">
              {users.slice(0, 5).map((u) => (
                <div key={u.id} className="flex items-center justify-between px-5 py-3">
                  <div>
                    <p className="text-sm text-gray-900 dark:text-white">{u.full_name}</p>
          ...
          <div className="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl">
            <div className="flex items-center justify-between px-5 py-4 border-b border-gray-200 dark:border-gray-800">
              <h2 className="font-semibold text-gray-900 dark:text-white text-sm">{t('admin.recent_posts')}</h2>
            ...
            <div className="divide-y divide-gray-200 dark:divide-gray-800">
              {articles.slice(0, 5).map((a) => {
                ...
                const color = ds === 1 ? 'bg-green-500/20 text-green-400' : ds === 0 ? 'bg-gray-200 dark:bg-gray-700 text-gray-600 dark:text-gray-400' : 'bg-yellow-500/20 text-yellow-400';
                return (
                  <div key={a.id} className="flex items-center justify-between px-5 py-3">
                    <p className="text-sm text-gray-900 dark:text-white line-clamp-1 flex-1 mr-3">{a.title}</p>
