            ...
            {user ? (
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="flex items-center gap-1 text-sm text-gray-400 hover:text-red-400 transition-colors px-2 py-1 rounded-lg hover:bg-gray-800"
                >
                  <LogOut size={16} />
              ...
              <div className="flex items-center gap-2">
                <Link href="/auth/login" className="text-sm text-gray-300 hover:text-white px-3 py-1.5 rounded-lg hover:bg-gray-800 transition-colors">
                  Login
                </Link>
                <Link href="/auth/register" className="text-sm bg-green-500 hover:bg-green-600 text-white px-3 py-1.5 rounded-lg transition-colors font-medium">
                  Sign Up
                </Link>
              </div>
            )}
